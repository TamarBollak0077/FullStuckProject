...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        => optionsBuilder.UseSqlServer("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=C:\\Users\\USER\\RehubCenterProject (2)\\RehubCenterProject\\RehubCenterServer\\Dal\\DataBase\\RehubDataBase.mdf;Integrated Security=True;Connect Timeout=30");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<PatientSession>(entity =>
        {
            ...
            entity.Property(e => e.PatientSessionId)
                .HasMaxLength(50)
                .IsUnicode(false)
